...
testfilter: libfreetype
	zig test src/window.zig --test-filter $(testname) -rpath modules/zig-freetype2/modules/freetype2/objs/libs --library-path modules/zig-freetype2/modules/freetype2/objs/.libs --library SDL2_image --library SDL2 --library freetype --library c
